...
public class Juice_Cart extends AppCompatActivity implements RecyclerItemTouchHelperListener {
    ...
    class C02841 implements OnClickListener {
        ...
        class C02821 implements DialogInterface.OnClickListener {
            ...
            public void onClick(DialogInterface dialog, int id) {
                Toast.makeText(Juice_Cart.this.getApplicationContext(), "Cancelled", 0).show();
                dialog.cancel();
            }
        }
        ...
        class C02832 implements DialogInterface.OnClickListener {
            ...
            public void onClick(DialogInterface dialog, int id) {
                Toast.makeText(Juice_Cart.this.getApplicationContext(), "Confirmed", 0).show();
            }
        }
        ...
        public void onClick(View v) {
            Builder alertDialogBuilder = new Builder(Juice_Cart.this.mContext);
            alertDialogBuilder.setCancelable(false);
            alertDialogBuilder.setTitle("Juice Order Confirmation");
            alertDialogBuilder.setMessage("Please Confirm Your Juice Order and Move to One Step Process");
            alertDialogBuilder.setCancelable(false).setPositiveButton("OK", new C02832()).setNegativeButton("Cancel", new C02821());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.single_textView.setText("Your Juice Cart");
        this.single_confirm_button.setOnClickListener(new C02841());
        ...
        if (viewHolder instanceof MyViewHolder) {
            ...
            snackbar.setAction((CharSequence) "UNDO", new OnClickListener() {
                public void onClick(View view) {
                    if (Long.valueOf(Juice_Cart.this.bf_database.create(name, shift_name)).longValue() == -1) {
                        Toast.makeText(Juice_Cart.this.getApplicationContext(), name + " : Not Added to Cart", 0).show();
                    } else {
                        Toast.makeText(Juice_Cart.this.getApplicationContext(), name + " : Added Back to Cart", 0).show();
                    }
                    Juice_Cart.this.adapter.restoreItem(deletedItem, deletedIndex);
                }
            });
