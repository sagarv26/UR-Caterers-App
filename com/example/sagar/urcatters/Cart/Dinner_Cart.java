...
public class Dinner_Cart extends AppCompatActivity implements RecyclerItemTouchHelperListener {
    ...
    class C02801 implements OnClickListener {
        ...
        class C02781 implements DialogInterface.OnClickListener {
            ...
            public void onClick(DialogInterface dialog, int id) {
                Toast.makeText(Dinner_Cart.this.getApplicationContext(), "Cancelled", 0).show();
                dialog.cancel();
            }
        }
        ...
        class C02792 implements DialogInterface.OnClickListener {
            ...
            public void onClick(DialogInterface dialog, int id) {
                Toast.makeText(Dinner_Cart.this.getApplicationContext(), "Confirmed", 0).show();
            }
        }
        ...
        public void onClick(View v) {
            Builder alertDialogBuilder = new Builder(Dinner_Cart.this.mContext);
            alertDialogBuilder.setCancelable(false);
            alertDialogBuilder.setTitle("Dinner Order Confirmation");
            alertDialogBuilder.setMessage("Please Confirm Your Dinner Order and Move to One Step Process");
            alertDialogBuilder.setCancelable(false).setPositiveButton("OK", new C02792()).setNegativeButton("Cancel", new C02781());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.single_textView.setText("Your Dinner Cart");
        this.single_confirm_button.setOnClickListener(new C02801());
        ...
        if (viewHolder instanceof MyViewHolder) {
            ...
            snackbar.setAction((CharSequence) "UNDO", new OnClickListener() {
                public void onClick(View view) {
                    if (Long.valueOf(Dinner_Cart.this.bf_database.create(name, shift_name)).longValue() == -1) {
                        Toast.makeText(Dinner_Cart.this.getApplicationContext(), name + " : Not Added to Cart", 0).show();
                    } else {
                        Toast.makeText(Dinner_Cart.this.getApplicationContext(), name + " : Added Back to Cart", 0).show();
                    }
                    Dinner_Cart.this.adapter.restoreItem(deletedItem, deletedIndex);
                }
            });
