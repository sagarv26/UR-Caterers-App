...
import com.example.sagar.urcatters.SubClass.Show_Details;
import java.util.List;

public class Caterers_Adapter_Lunch extends Adapter<ViewHolder> {
    ...
    public class ViewHolder extends android.support.v7.widget.RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new OnClickListener(Caterers_Adapter_Lunch.this) {
                public void onClick(View v) {
                    Caterers_Adapter_Lunch.this.ChangePage((DetailItem) Caterers_Adapter_Lunch.this.listItem.get(ViewHolder.this.getAdapterPosition()));
                }
            });
        }
    }

    public Caterers_Adapter_Lunch(List<DetailItem> listItem, Context mContext) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.order_image.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Caterers_Adapter_Lunch.this.ChangePage((DetailItem) Caterers_Adapter_Lunch.this.listItem.get(position));
            }
        });
    }
