...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mBorderWidth = 0;
        this.mCircleBackgroundColor = 0;
        TypedArray a = context.obtainStyledAttributes(attrs, C0307R.styleable.CircleImageView, defStyle, 0);
        this.mBorderWidth = a.getDimensionPixelSize(C0307R.styleable.CircleImageView_civ_border_width, 0);
        this.mBorderColor = a.getColor(C0307R.styleable.CircleImageView_civ_border_color, -16777216);
        this.mBorderOverlay = a.getBoolean(C0307R.styleable.CircleImageView_civ_border_overlay, false);
        if (a.hasValue(C0307R.styleable.CircleImageView_civ_circle_background_color)) {
            this.mCircleBackgroundColor = a.getColor(C0307R.styleable.CircleImageView_civ_circle_background_color, 0);
        } else if (a.hasValue(C0307R.styleable.CircleImageView_civ_fill_color)) {
            this.mCircleBackgroundColor = a.getColor(C0307R.styleable.CircleImageView_civ_fill_color, 0);
        }
        a.recycle();
        init();
    }
