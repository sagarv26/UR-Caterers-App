...
public class ViewPager extends ViewGroup {
    ...
    class C03734 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03741());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C03741 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03741() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03734());
    }
