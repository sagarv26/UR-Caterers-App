...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    final Callback mManagerCallback = new C03153();
    ...
    class C03142 implements OnApplyWindowInsetsListener {
        C03142() {
        }
    ...
    class C03153 implements Callback {
        C03153() {
        }
    ...
    class C03164 implements OnDismissListener {
        C03164() {
        }
    ...
    class C03175 implements OnAttachStateChangeListener {
    ...
    class C03186 implements OnLayoutChangeListener {
        C03186() {
        }
    ...
    class C04417 extends ViewPropertyAnimatorListenerAdapter {
        C04417() {
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        if (parent == null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C03142());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C03164());
                clp.setBehavior(behavior);
                clp.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C03175());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C03186());
    ...
    void animateViewIn() {
        if (VERSION.SDK_INT >= 14) {
            ...
            ViewCompat.animate(this.mView).translationY(0.0f).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setDuration(250).setListener(new C04417()).start();
            return;
        }
