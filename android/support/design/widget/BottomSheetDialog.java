...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C03232 extends AccessibilityDelegateCompat {
        C03232() {
        }
    ...
    class C03243 extends BottomSheetCallback {
        C03243() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C03243();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C03232());
        return coordinator;
    }
