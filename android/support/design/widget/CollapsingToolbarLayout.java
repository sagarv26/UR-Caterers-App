...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C03261 implements OnApplyWindowInsetsListener {
        C03261() {
        }
    ...
    class C03272 implements AnimatorUpdateListener {
        C03272() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03261());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new C03272());
