...
public class TextInputLayout extends LinearLayout {
    ...
    class C03385 implements AnimatorUpdateListener {
        C03385() {
        }
    ...
    class C04452 extends ViewPropertyAnimatorListenerAdapter {
        C04452() {
        }
    ...
    private void setError(@Nullable final CharSequence error, boolean animate) {
        ...
        if (this.mErrorShown) {
            ...
            if (animate) {
                ...
                ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C04452()).start();
            } else {
    ...
    void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.addUpdateListener(new C03385());
            }
