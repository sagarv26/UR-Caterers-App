...
public class ParcelableSparseArray extends SparseArray<Parcelable> implements Parcelable {
    public static final Creator<ParcelableSparseArray> CREATOR = ParcelableCompat.newCreator(new C03091());

    static class C03091 implements ParcelableCompatCreatorCallbacks<ParcelableSparseArray> {
        C03091() {
        }
