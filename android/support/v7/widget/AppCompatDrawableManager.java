...
public final class AppCompatDrawableManager {
    private static final int[] COLORFILTER_COLOR_BACKGROUND_MULTIPLY = new int[]{C0180R.drawable.abc_popup_background_mtrl_mult, C0180R.drawable.abc_cab_background_internal_bg, C0180R.drawable.abc_menu_hardkey_panel_mtrl_mult};
    private static final int[] COLORFILTER_COLOR_CONTROL_ACTIVATED = new int[]{C0180R.drawable.abc_textfield_activated_mtrl_alpha, C0180R.drawable.abc_textfield_search_activated_mtrl_alpha, C0180R.drawable.abc_cab_background_top_mtrl_alpha, C0180R.drawable.abc_text_cursor_material, C0180R.drawable.abc_text_select_handle_left_mtrl_dark, C0180R.drawable.abc_text_select_handle_middle_mtrl_dark, C0180R.drawable.abc_text_select_handle_right_mtrl_dark, C0180R.drawable.abc_text_select_handle_left_mtrl_light, C0180R.drawable.abc_text_select_handle_middle_mtrl_light, C0180R.drawable.abc_text_select_handle_right_mtrl_light};
    private static final int[] COLORFILTER_TINT_COLOR_CONTROL_NORMAL = new int[]{C0180R.drawable.abc_textfield_search_default_mtrl_alpha, C0180R.drawable.abc_textfield_default_mtrl_alpha, C0180R.drawable.abc_ab_share_pack_mtrl_alpha};
    ...
    private static final int[] TINT_CHECKABLE_BUTTON_LIST = new int[]{C0180R.drawable.abc_btn_check_material, C0180R.drawable.abc_btn_radio_material};
    private static final int[] TINT_COLOR_CONTROL_NORMAL = new int[]{C0180R.drawable.abc_ic_commit_search_api_mtrl_alpha, C0180R.drawable.abc_seekbar_tick_mark_material, C0180R.drawable.abc_ic_menu_share_mtrl_alpha, C0180R.drawable.abc_ic_menu_copy_mtrl_am_alpha, C0180R.drawable.abc_ic_menu_cut_mtrl_alpha, C0180R.drawable.abc_ic_menu_selectall_mtrl_alpha, C0180R.drawable.abc_ic_menu_paste_mtrl_am_alpha};
    private static final int[] TINT_COLOR_CONTROL_STATE_LIST = new int[]{C0180R.drawable.abc_tab_indicator_material, C0180R.drawable.abc_textfield_search_material};
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (resId == C0180R.drawable.abc_cab_background_top_material) {
            dr = new LayerDrawable(new Drawable[]{getDrawable(context, C0180R.drawable.abc_cab_background_internal_bg), getDrawable(context, C0180R.drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (dr != null) {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int resId, boolean failIfNotKnown, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            return drawable;
        } else if (resId == C0180R.drawable.abc_seekbar_track_material) {
            ld = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0180R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0180R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0180R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else if (resId == C0180R.drawable.abc_ratingbar_material || resId == C0180R.drawable.abc_ratingbar_indicator_material || resId == C0180R.drawable.abc_ratingbar_small_material) {
            ld = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0180R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0180R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0180R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
    ...
    static boolean tintDrawableUsingColorFilter(@NonNull Context context, @DrawableRes int resId, @NonNull Drawable drawable) {
        ...
        if (arrayContains(COLORFILTER_TINT_COLOR_CONTROL_NORMAL, resId)) {
            colorAttr = C0180R.attr.colorControlNormal;
            colorAttrSet = true;
        } else if (arrayContains(COLORFILTER_COLOR_CONTROL_ACTIVATED, resId)) {
            colorAttr = C0180R.attr.colorControlActivated;
            colorAttrSet = true;
        } else if (arrayContains(COLORFILTER_COLOR_BACKGROUND_MULTIPLY, resId)) {
            colorAttr = 16842801;
            colorAttrSet = true;
            tintMode = Mode.MULTIPLY;
        } else if (resId == C0180R.drawable.abc_list_divider_mtrl_alpha) {
            colorAttr = 16842800;
            colorAttrSet = true;
            alpha = Math.round(40.8f);
        } else if (resId == C0180R.drawable.abc_dialog_material_background) {
            colorAttr = 16842801;
            colorAttrSet = true;
        }
        if (!colorAttrSet) {
    ...
    static Mode getTintMode(int resId) {
        if (resId == C0180R.drawable.abc_switch_thumb_material) {
    ...
    ColorStateList getTintList(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (tint == null) {
            if (resId == C0180R.drawable.abc_edit_text_material) {
                tint = AppCompatResources.getColorStateList(context, C0180R.color.abc_tint_edittext);
            } else if (resId == C0180R.drawable.abc_switch_track_mtrl_alpha) {
                tint = AppCompatResources.getColorStateList(context, C0180R.color.abc_tint_switch_track);
            } else if (resId == C0180R.drawable.abc_switch_thumb_material) {
                tint = AppCompatResources.getColorStateList(context, C0180R.color.abc_tint_switch_thumb);
            } else if (resId == C0180R.drawable.abc_btn_default_mtrl_shape) {
                tint = createDefaultButtonColorStateList(context);
            } else if (resId == C0180R.drawable.abc_btn_borderless_material) {
                tint = createBorderlessButtonColorStateList(context);
            } else if (resId == C0180R.drawable.abc_btn_colored_material) {
                tint = createColoredButtonColorStateList(context);
            } else if (resId == C0180R.drawable.abc_spinner_mtrl_am_alpha || resId == C0180R.drawable.abc_spinner_textfield_background_material) {
                tint = AppCompatResources.getColorStateList(context, C0180R.color.abc_tint_spinner);
            } else if (arrayContains(TINT_COLOR_CONTROL_NORMAL, resId)) {
                tint = ThemeUtils.getThemeAttrColorStateList(context, C0180R.attr.colorControlNormal);
            } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, resId)) {
                tint = AppCompatResources.getColorStateList(context, C0180R.color.abc_tint_default);
            } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, resId)) {
                tint = AppCompatResources.getColorStateList(context, C0180R.color.abc_tint_btn_checkable);
            } else if (resId == C0180R.drawable.abc_seekbar_thumb_material) {
                tint = AppCompatResources.getColorStateList(context, C0180R.color.abc_tint_seek_thumb);
            }
            if (tint != null) {
    ...
    private ColorStateList createDefaultButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0180R.attr.colorButtonNormal));
    }
    ...
    private ColorStateList createColoredButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0180R.attr.colorAccent));
    }

    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int baseColor) {
        states = new int[4][];
        colors = new int[4];
        int colorControlHighlight = ThemeUtils.getThemeAttrColor(context, C0180R.attr.colorControlHighlight);
        int disabledColor = ThemeUtils.getDisabledThemeAttrColor(context, C0180R.attr.colorButtonNormal);
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            Drawable d = getDrawable(context, C0180R.drawable.abc_vector_test);
