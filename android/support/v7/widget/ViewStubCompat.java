...
public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0180R.styleable.ViewStubCompat, defStyle, 0);
        this.mInflatedId = a.getResourceId(C0180R.styleable.ViewStubCompat_android_inflatedId, -1);
        this.mLayoutResource = a.getResourceId(C0180R.styleable.ViewStubCompat_android_layout, 0);
        setId(a.getResourceId(C0180R.styleable.ViewStubCompat_android_id, -1));
        a.recycle();
        setVisibility(8);
        setWillNotDraw(true);
    }
