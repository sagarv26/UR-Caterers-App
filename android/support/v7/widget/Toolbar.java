...
public class Toolbar extends ViewGroup {
    ...
    class C04191 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C04191() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C04201());
        int expandedMenuItemId;
        boolean isOverflowOpen;

        static class C04201 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C04201() {
            }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C04191();
