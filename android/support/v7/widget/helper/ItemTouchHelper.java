...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C04212();
    ...
    class C04212 implements OnItemTouchListener {
        C04212() {
        }
    ...
    class C04225 implements ChildDrawingOrderCallback {
        C04225() {
        }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C04225();
            }
