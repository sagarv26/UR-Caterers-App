...
public class ShareActionProvider extends ActionProvider {
    ...
    public View onCreateActionView() {
        ...
        this.mContext.getTheme().resolveAttribute(C0180R.attr.actionModeShareDrawable, outTypedValue, true);
        ...
        activityChooserView.setDefaultActionButtonContentDescription(C0180R.string.abc_shareactionprovider_share_with_application);
        activityChooserView.setExpandActivityOverflowButtonContentDescription(C0180R.string.abc_shareactionprovider_share_with);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (collapsedActivityCount < expandedActivityCount) {
            SubMenu expandedSubMenu = subMenu.addSubMenu(0, collapsedActivityCount, collapsedActivityCount, this.mContext.getString(C0180R.string.abc_activity_chooser_view_see_all));
