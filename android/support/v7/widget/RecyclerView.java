...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C04131();
        ...
        private final Callback mVerticalBoundCheckCallback = new C04142();
        private int mWidth;
        ...
        class C04142 implements Callback {
            C04142() {
            }
    ...
    class C04104 implements ProcessCallback {
        C04104() {
        }
    ...
    class C04115 implements Callback {
        C04115() {
        }
    ...
    class C04126 implements Callback {
        C04126() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C04151());
        Parcelable mLayoutState;

        static class C04151 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C04151() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mViewInfoProcessCallback = new C04104();
        if (attrs != null) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C04115());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C04126());
    }
