...
public class ListMenuItemView extends LinearLayout implements ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, C0180R.attr.listMenuViewStyle);
    }

    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0180R.styleable.MenuView, defStyleAttr, 0);
        this.mBackground = a.getDrawable(C0180R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0180R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0180R.styleable.MenuView_preserveIconSpacing, false);
        this.mTextAppearanceContext = context;
        this.mSubMenuArrow = a.getDrawable(C0180R.styleable.MenuView_subMenuArrow);
        a.recycle();
    }
    ...
    protected void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0180R.id.title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0180R.id.shortcut);
        this.mSubMenuArrowView = (ImageView) findViewById(C0180R.id.submenuarrow);
    ...
    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(C0180R.layout.abc_list_menu_item_icon, this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(C0180R.layout.abc_list_menu_item_radio, this, false);
        addView(this.mRadioButton);
    }

    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(C0180R.layout.abc_list_menu_item_checkbox, this, false);
