...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(null, C0180R.styleable.DrawerArrowToggle, C0180R.attr.drawerArrowStyle, C0180R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(a.getColor(C0180R.styleable.DrawerArrowToggle_color, 0));
        setBarThickness(a.getDimension(C0180R.styleable.DrawerArrowToggle_thickness, 0.0f));
        setSpinEnabled(a.getBoolean(C0180R.styleable.DrawerArrowToggle_spinBars, true));
        setGapSize((float) Math.round(a.getDimension(C0180R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = a.getDimensionPixelSize(C0180R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = (float) Math.round(a.getDimension(C0180R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = (float) Math.round(a.getDimension(C0180R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
        this.mArrowShaftLength = a.getDimension(C0180R.styleable.DrawerArrowToggle_arrowShaftLength, 0.0f);
        a.recycle();
    }
