    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T> callback) {
        return new BackgroundCallback<T>() {
            ...
            class C01851 implements Runnable {
                ...
                public void run() {
                    while (true) {
                        SyncQueueItem msg = C03962.this.mQueue.next();
                        if (msg != null) {
                            switch (msg.what) {
                                case 1:
                                    C03962.this.mQueue.removeMessages(1);
                                    callback.refresh(msg.arg1);
                                    break;
                                case 2:
                                    C03962.this.mQueue.removeMessages(2);
                                    C03962.this.mQueue.removeMessages(3);
                        ...
                        C03962.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
