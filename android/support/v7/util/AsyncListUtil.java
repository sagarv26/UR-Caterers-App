...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C03932();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C03921();
    ...
    class C03921 implements MainThreadCallback<T> {
        C03921() {
        }
    ...
    class C03932 implements BackgroundCallback<T> {
