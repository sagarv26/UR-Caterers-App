...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C04561();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C04572();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03913();

    class C03913 implements ViewPropertyAnimatorUpdateListener {
        C03913() {
        }
    ...
    class C04561 extends ViewPropertyAnimatorListenerAdapter {
        C04561() {
        }
    ...
    class C04572 extends ViewPropertyAnimatorListenerAdapter {
        C04572() {
        }
