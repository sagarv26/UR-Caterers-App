...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01775 implements Runnable {
        ...
        class C04531 extends ViewPropertyAnimatorListenerAdapter {
            C04531() {
            }
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C04531());
                return;
            }
            ViewCompat.setAlpha(AppCompatDelegateImplV9.this.mActionModeView, 1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03891());
            int featureId;
            boolean isOpen;
            Bundle menuState;

            static class C03891 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C03891() {
                }
    ...
    class C03862 implements OnApplyWindowInsetsListener {
        C03862() {
        }
    ...
    class C03873 implements OnFitSystemWindowsListener {
        C03873() {
        }
    ...
    class C03884 implements OnAttachListener {
        C03884() {
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C04551 extends ViewPropertyAnimatorListenerAdapter {
            C04551() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C04551());
            }
    ...
    class C04546 extends ViewPropertyAnimatorListenerAdapter {
        C04546() {
        }
        ...
        if (a.hasValue(C0180R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C03862());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C03873());
                }
            ...
            contentView.setAttachListener(new C03884());
            return subDecor;
        }
        a.recycle();
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C04546());
                    } else {
