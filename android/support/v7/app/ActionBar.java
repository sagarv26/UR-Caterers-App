...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = 0;
            TypedArray a = c.obtainStyledAttributes(attrs, C0180R.styleable.ActionBarLayout);
            this.gravity = a.getInt(C0180R.styleable.ActionBarLayout_android_layout_gravity, 0);
            a.recycle();
        }
