...
public class NotificationCompat extends android.support.v4.app.NotificationCompat {
    ...
    private static void setBackgroundColor(Context context, RemoteViews views, int color) {
        if (color == 0) {
            color = context.getResources().getColor(C0180R.color.notification_material_background_media_default_color);
        }
        views.setInt(C0180R.id.status_bar_latest_event_content, "setBackgroundColor", color);
    }
